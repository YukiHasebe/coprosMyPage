...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedName = sessionStorage.getItem('userName') || "ゲスト";
        ...
        <header class="h-16 bg-[#3c4b5a] flex items-center justify-between px-6 text-white shadow-lg shrink-0 z-50 sticky top-0">
            ...
            <div class="flex items-center gap-4">
                <div class="text-right mr-1 hidden xs:block">
                    ...
                    <p id="user-display-name" class="text-sm font-black tracking-wider text-white">${savedName.replace(/[様殿]$/, "")}</p>
                </div>
            ...
            <nav class="flex-1 overflow-y-auto py-2 custom-scrollbar text-[13px]">
                <div class="nav-group">
                    ...
                    <div class="submenu hidden bg-black/20">
                        <div class="py-2.5 pl-14 pr-4 opacity-70 hover:opacity-100 hover:text-[#87ceeb] cursor-pointer" onclick="location.href='list.html'">お客様情報一覧</div>
                ...
                <div class="nav-group">
                    ...
                    <div class="submenu hidden bg-black/20">
                        ...
                        <div class="py-2.5 pl-14 pr-4 opacity-70 hover:opacity-100 hover:text-[#87ceeb] cursor-pointer" onclick="location.href='staff_list.html'">組織員情報登録</div>
                        <div class="py-2.5 pl-14 pr-4 opacity-70 hover:opacity-100 hover:text-[#87ceeb] cursor-pointer" onclick="location.href='import.html'">インポート</div>
                    </div>
                </div>
            </nav>
    ...
    document.querySelectorAll('[onclick], .item-link').forEach(el => {
        ...
        if (action.includes(`'${currentFile}'`)) {
            ...
            if(pg){ 
                ...
                el.querySelector('.icon-to-color').classList.add('text-[#87ceeb]');
            }
        }
    });
    ...
    async function refreshBadge() {
        if(!savedName || savedName === "ゲスト") return;
        try { 
