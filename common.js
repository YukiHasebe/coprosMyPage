...
document.addEventListener('DOMContentLoaded', () => {
    ...
    sp.innerHTML = `
        ...
        <aside id="main-sidebar" class="sidebar flex flex-col shrink-0 fixed lg:static inset-y-0 left-0 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300" style="width: 220px; background-color: #1a1a1a; color: white; height: 100vh;">
            <div class="h-16 flex items-center px-6 text-gray-500 font-black text-xs border-b border-gray-800 uppercase">Menu</div>
            ...
            <div class="p-6 border-t border-gray-800 bg-[#1a1a1a]"><button id="logout-btn" class="flex items-center gap-3 text-gray-500 hover:text-rose-400 font-bold w-full transition-colors"><i class="fa-solid fa-power-off"></i><span>ログアウト</span></button></div>
        </aside>
    `;
